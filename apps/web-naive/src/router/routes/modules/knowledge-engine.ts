    ...
    children: [
      {
        name: 'KnowledgeList',
        path: '/knowledge/list',
        component: () => import('#/views/knowledge-engine/knowledge-list/list.vue'),
        meta: { icon: 'lucide:database', title: $t('page.knowledge.list') },
      },
      {
        name: 'KnowledgeGraph',
        path: '/knowledge/graph',
        component: () => import('#/views/knowledge-engine/knowledge-graph/index.vue'),
      ...
      },
      {
        ...
        meta: { icon: 'lucide:file-text', title: $t('page.knowledge.document') },
      },
      {
        name: 'KnowledgeIndex',
        path: '/knowledge/index',
        component: () => import('#/views/knowledge-engine/index-rebuild/list.vue'),
