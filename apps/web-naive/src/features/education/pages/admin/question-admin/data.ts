...
import type { EducationQuestionApi } from '#/features/education/api';
  ...
  return [
    ...
    },
    {
      ...
      rules: z
        ...
        .min(
          1,
          $t('ui.formRules.required', [$t('education.question.questionTitle')]),
        ),
    },
    {
      component: 'Select',
      ...
      componentProps: {
        options: [
          ...
          {
            label: $t('education.question.typeExperiment'),
            value: 'EXPERIMENT',
          },
        ],
      },
    ...
    {
      component: 'Input',
      fieldName: 'abilityDimension',
      label: $t('education.question.abilityDimension'),
    },
    {
      component: 'Input',
      componentProps: { type: 'textarea', rows: 3 },
      fieldName: 'options',
      label: $t('education.question.options'),
    },
    {
      component: 'Input',
      componentProps: { type: 'textarea', rows: 3 },
    ...
    },
    {
      ...
      componentProps: { type: 'textarea', rows: 3 },
      fieldName: 'analysis',
      label: $t('education.question.analysis'),
    },
    {
      component: 'Input',
      fieldName: 'tags',
      label: $t('education.question.tags'),
    },
  ];
}

export function useColumns(
  onActionClick?: OnActionClickFn<EducationQuestionApi.Question>,
): VxeTableGridColumns<EducationQuestionApi.Question> {
  return [
    ...
    {
      field: 'title',
      title: $t('education.question.questionTitle'),
      width: 250,
    },
    {
      field: 'subjectCode',
      title: $t('education.question.subjectCode'),
      width: 100,
    },
    {
      field: 'difficulty',
      title: $t('education.question.difficulty'),
      width: 80,
    },
    {
      field: 'usedCount',
      title: $t('education.question.usedCount'),
      width: 100,
    },
    {
      align: 'right',
      cellRender: {
        attrs: {
          nameField: 'code',
          nameTitle: $t('education.question.name'),
