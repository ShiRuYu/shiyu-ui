...
import type { EducationReviewApi } from '#/features/education/api';
...
import { createReview, updateReview } from '#/features/education/api';
...
const [Modal, modalApi] = useVbenModal<EducationReviewApi.ReviewTask>({
  async onConfirm() {
