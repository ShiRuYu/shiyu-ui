...
import type { EducationTextbookApi } from '#/features/education/api';
  ...
  return [
    {
      component: 'Input',
      fieldName: 'name',
      label: $t('education.textbook.name'),
    },
    {
      component: 'Input',
      fieldName: 'publisher',
      label: $t('education.textbook.publisher'),
    },
  ];
}
...
export function useSchema(): VbenFormSchema[] {
  return [
    ...
    },
    {
      component: 'Input',
      fieldName: 'isbn',
      label: $t('education.textbook.isbn'),
    },
  ];
}

export function useColumns(
  onActionClick?: OnActionClickFn<EducationTextbookApi.Textbook>,
): VxeTableGridColumns<EducationTextbookApi.Textbook> {
  return [
    ...
    { field: 'isbn', title: $t('education.textbook.isbn'), width: 150 },
    {
      ...
      cellRender: {
        attrs: {
          nameField: 'name',
          nameTitle: $t('education.textbook.name'),
