...
async function createWorkspace(
  ...
  return requestClient.post('/workspace/create', data);
}
...
async function updateWorkspace(
  ...
  return requestClient.post('/workspace/update', data, { params: { id } });
}
...
async function deleteWorkspace(id: number) {
  return requestClient.post('/workspace/delete', null, { params: { id } });
}
