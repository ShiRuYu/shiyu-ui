...
async function updateWorkspace(
  ...
  return requestClient.post('/auth/workspace/update', data, { params: { id } });
}
...
async function deleteWorkspace(id: number) {
  return requestClient.post('/auth/workspace/delete', null, { params: { id } });
}
