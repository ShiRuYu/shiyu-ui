...
async function getRecordPage(params?: Recordable<any>) {
  ...
  return requestClient.get<RecordsApi.PageResult<RecordsApi.Record>>('/api/record/page', {
...
export { createRecord, deleteRecord, getRecordById, getRecordPage, updateRecord };
