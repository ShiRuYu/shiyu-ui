...
async function updateCourse(
  ...
  return requestClient.post('/v1/education/course/update', data, {
    params: { id },
  });
}
...
async function deleteCourse(id: number) {
  return requestClient.post('/v1/education/course/delete', null, {
    params: { id },
  });
}
