...
| 目录 | 职责 |
| --- | --- |
| `features/core` | 平台概览与分析工作台；浏览器路由为 `/workbench` |
| `features/agent` | Agent 定义、版本、图编排、意图、平台、模型和聊天 |
| `features/knowledge` | 工作台、空间、资产、文档、图谱、检索、评测、索引和运维 |
| `features/education` | 课程、知识点、学习计划、练习、考试、复习和资源 |
| `features/education` | AI 家教、规划、教师和报告 |
| `features/governance` | 能力雷达、趋势、薄弱点和运行报告 |
| `features/education` | 教育基础数据和业务后台 |
| `features/record` | 档案、记录、时间线、媒体和标签 |
